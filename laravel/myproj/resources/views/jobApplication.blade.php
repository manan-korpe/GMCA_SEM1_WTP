...
<body>
 <form id="applicationForm" onsubmit="handleForm(this)" action='{{ route('jobApplication.submit') }}' method="post" enctype="multipart/form-data">
    @csrf    
    <h2 class="title">Job Application Form</h2>
        ...
        <div class="btn-handler">
            ...
            <a style="text-align:center" lass="form-link" href='{{ route('home') }}'>Home</a>
        </div>

window.addEventListener("DOMContentLoaded", () => {
    ...
    console.log(ageMaxDate.toISOString().split("T")[0]);
    document.getElementById("start-date").min = todayDate.toISOString().split("T")[0];
    document.getElementById("dob").max = ageMaxDate.toISOString().split("T")[0];
